---
title: "Wisconsin Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Wisconsin agency disclosure requirements 2026 explained for agents and brokers, including form numbers, deadlines, common mistakes, and liability risks."
...
tags: ["agency-disclosure-requirements", "wisconsin", "compliance"]
keywords: ["Wisconsin agency disclosure requirements 2026", "wisconsin real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to provide agency disclosure in Wisconsin?"
    a: "You must provide the DSPS Agent Disclosure and Election form at the earliest of three events: first substantive contact, showing a property, or providing services beyond ministerial acts. Wisconsin Administrative Code REEB 24.04 controls the timing."
  - q: "What happens if I forget to give the agency disclosure form in Wisconsin?"
    a: "Failure to provide timely disclosure can result in DSPS disciplinary action, license suspension or revocation, civil liability for damages, and potential rescission of the transaction by the aggrieved party under Wis. Stat. 452.135."
  - q: "Do I need a separate disclosure form for dual agency in Wisconsin?"
    a: "Yes. If you transition to dual agency (multiple representation), you must obtain written, informed consent from both parties on a separate consent form before acting in that capacity. The WB-46 is the standard form used for this election."
  - q: "Does Wisconsin allow designated agency?"
    a: "No. Wisconsin does not recognize designated agency. The state uses a customer/client model under Wis. Stat. 452.133-452.139, where agents either represent a party as a client or work with them as a customer with limited duties."
---
...
## The Forms That Matter: WB-36 and Related Documents
...
|------|---------|---------------|
| Agent Disclosure and Election | Discloses agency role, allows client/customer election | First substantive contact |
| WB-46 | Consent for multiple representation (dual agency) | Before firm represents both parties |
| WB-36 (Buyer Agency Agreement) | Formalizes client relationship with buyer | When buyer elects client status |
| Listing Agreement (WB-1 or WB-4) | Formalizes client relationship with seller | At listing appointment |
...
Agents working with [seller disclosure forms in Wisconsin](/blog/wisconsin-seller-disclosure-requirements-2026) should note that agency disclosure and property condition disclosure are entirely separate obligations with different timing requirements and different consequences for noncompliance.
...
If you are [tracking multiple active deals](/blog/track-multiple-active-deals) simultaneously, building a system that flags disclosure status for each party in each transaction prevents these errors from compounding across your pipeline.
...
|-------------|---------------|----------|
| Timing documentation | Date/time of first substantive contact vs. date on disclosure form | Forms dated same day as accepted offer |
| Customer vs. client elections | Written election on file for every party in every transaction | Missing elections or unsigned forms |
| Multiple representation consent | WB-46 executed before firm acts for both parties | Consent obtained after offer presentation |
| Open house protocols | Agents carrying disclosure forms, documenting substantive contact triggers | No forms available at open house events |
| File completeness | Every transaction file contains agency disclosure for each party the agent worked with | Files with only listing-side or only buyer-side documentation |

Brokers should conduct quarterly audits of randomly selected transaction files, not just closed files. Pending and terminated transactions often reveal compliance gaps that never surface in closed files because the deal fell apart before anyone examined the paperwork. A [structured handoff checklist](/blog/transaction-handoff-checklist) between agents and transaction coordinators can catch missing disclosures before they become embedded problems.
