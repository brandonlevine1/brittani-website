---
title: "Iowa Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Iowa agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make. Stay compliant and avoid liability."
...
tags: ["agency-disclosure-requirements", "iowa", "compliance"]
keywords: ["Iowa agency disclosure requirements 2026", "iowa real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to provide agency disclosure in Iowa?"
    a: "You must provide written agency disclosure at the first substantive contact with a prospective buyer or seller, before any confidential information is exchanged. Iowa Code Chapter 543B.57 requires this timing regardless of whether a formal agreement has been signed."
  - q: "What form do Iowa agents use for agency disclosure?"
    a: "Iowa agents use the Iowa Real Estate Commission's approved Agency Disclosure Form, currently referenced as the IREC Agency Disclosure pamphlet. Most brokerages distribute versions aligned with Iowa Association of Realtors Form 101."
  - q: "What happens if I forget to give the agency disclosure in Iowa?"
    a: "Failure to disclose can result in disciplinary action by the Iowa Real Estate Commission including fines up to $5,000, license suspension, and potential deal rescission if a party can show they were harmed by the omission."
  - q: "Can I represent both buyer and seller in Iowa?"
    a: "Yes, dual agency is legal in Iowa but only with informed written consent from both parties before the dual representation begins. You must use the proper consent form and document it in the transaction file."
---
...
|------|---------|---------------|-----------|
| IAR Form 101 | Agency Disclosure | First substantive contact | Agent and consumer |
| IAR Form 103 | Consent to Dual Agency | Before dual representation begins | Both buyer and seller |
| IAR Form 105 | Designated Agency Disclosure | When brokerage assigns separate agents | Both parties and designated agents |
| IREC Pamphlet | Consumer guide to agency | First substantive contact | Consumer acknowledgment |
...
| Violation | Possible Penalty | Regulatory Body |
|-----------|-----------------|-----------------|
| Failure to disclose at first substantive contact | Fine up to $2,500; formal reprimand | IREC |
| Operating as undisclosed dual agent | Fine up to $5,000; license suspension | IREC |
| Failure to maintain disclosure records | Fine; mandatory audit | IREC |
| Willful or repeated violations | License revocation | IREC |
| Consumer harm from non-disclosure | Civil lawsuit; contract rescission | Iowa District Court |

Errors and omissions insurance may not cover claims arising from intentional non-disclosure. Most E&O policies contain exclusions for regulatory violations that result from the agent's knowing failure to follow required procedures. This means agents could face personal financial exposure if a deal collapses due to missing disclosures, a risk that parallels issues agents encounter [when deals break down](/blog/where-deals-break-down) at the compliance stage.
...
Mistake two: using outdated forms. IREC periodically updates its approved language and pamphlets. Agents who printed a stack of Form 101 in 2022 and never checked for revisions may be distributing non-compliant documents. Always verify your forms against the current versions posted on the [Iowa Professional Licensing Bureau's website](https://plb.iowa.gov/real-estate).
...
The [NAR settlement changes](/blog/nar-settlement-year-one) that took effect in 2024 added another layer of complexity to buyer agency documentation nationally, and Iowa agents should ensure their disclosure practices account for both state requirements and MLS-level rule changes around compensation disclosure.
