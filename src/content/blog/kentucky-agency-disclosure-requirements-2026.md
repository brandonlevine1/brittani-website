---
title: "Kentucky Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Kentucky agency disclosure requirements 2026 explained for agents and brokers—specific forms, statutes, penalties, and common mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "kentucky", "compliance"]
keywords: ["Kentucky agency disclosure requirements 2026", "kentucky real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Kentucky?"
    a: "You must provide the agency disclosure at the earliest practical time, which Kentucky statute interprets as before or at the time substantive discussions about a specific property begin. Waiting until a contract is drafted is too late."
  - q: "What form do Kentucky agents use for agency disclosure?"
    a: "Kentucky agents use KREC Form 300, the Disclosure of Agency form, which must be signed by all parties and retained in the transaction file."
  - q: "What happens if I forget to give the agency disclosure in Kentucky?"
    a: "Failure to disclose can result in disciplinary action from the Kentucky Real Estate Commission, including fines up to $1,000, license suspension, and potential civil liability if a party claims they were harmed by undisclosed dual agency."
  - q: "Does Kentucky allow dual agency?"
    a: "Yes, but only with written informed consent from both buyer and seller. The agent must use KREC Form 300 to disclose the dual agency relationship and obtain signatures before proceeding."
---
...
The [Kentucky Real Estate Commission](https://krec.ky.gov/) publishes updated guidance annually and maintains the official forms on its website.
...
|------|---------|---------------|-----------|
| KREC Form 300 | Disclosure of Agency | Before substantive discussions | All parties + licensee |
| KREC Form 301 | Consent to Dual Agency | Before dual agency begins | Both buyer and seller |
| KREC Form 302 | Confirmation of Agency | At contract execution | All parties |
...
**If you are working with a buyer who decides to tour your own listing, the dual agency disclosure must happen before the showing.** Not after they fall in love with the kitchen. Not at the offer stage. Before the showing. This timing requirement catches even experienced agents, particularly those [managing multiple active deals](/blog/track-multiple-active-deals) simultaneously.
...
| Violation Level | Potential Penalty | Additional Risk |
|----------------|-------------------|-----------------|
| First offense, administrative | Letter of reprimand + mandatory CE | Brokerage audit triggered |
| Repeated or willful failure | Fine up to $1,000 + suspension | Civil liability from harmed party |
| Undisclosed dual agency | License revocation possible | Contract voidability by either party |
| Falsified disclosure forms | Criminal referral possible | E&O claim + brokerage liability |

Beyond KREC discipline, civil liability looms large. A buyer or seller who discovers they were in an undisclosed dual agency relationship can seek rescission of the contract and damages. Kentucky courts have upheld rescission claims where agency was not properly disclosed, reasoning that the consumer's consent to the transaction was not fully informed. This mirrors trends seen in [neighboring Tennessee's disclosure framework](/blog/tennessee-agency-disclosure-requirements-2026) as well.
