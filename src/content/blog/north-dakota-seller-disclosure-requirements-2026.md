---
title: "North Dakota Seller Disclosure Requirements 2026: What Every Agent and Broker Must Know"
description: "North Dakota seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, liability risks, and audit steps to stay compliant."
...
tags: ["seller-disclosure-requirements", "north-dakota", "compliance"]
keywords: ["North Dakota seller disclosure requirements 2026", "north dakota real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need a seller disclosure form for every residential sale in North Dakota?"
    a: "Yes, unless the transaction qualifies for a statutory exemption such as foreclosure, court-ordered sale, or transfers between co-owners. NDCC 47-10-02.1 mandates the disclosure for most residential sales of one to four units."
  - q: "What happens if my seller refuses to fill out the disclosure?"
    a: "If the seller is not exempt, the buyer can cancel the purchase agreement within the statutory review period without penalty. Agents should document the refusal in writing and advise the seller of legal exposure."
  - q: "How long does a buyer have to review the disclosure in North Dakota?"
    a: "Buyers have a minimum of three business days after receiving the completed disclosure to rescind the offer, per NDCC 47-10-02.1."
  - q: "Who is liable if a material defect was not disclosed—the agent or the seller?"
    a: "Primary liability falls on the seller for misrepresentation, but an agent who knew or should have known about a defect and failed to disclose it can face disciplinary action from the North Dakota Real Estate Commission and civil liability."
---
...
The disclosure framework in North Dakota is narrower than what you will find in states like [Oregon](/blog/oregon-seller-disclosure-requirements-2026) or [Pennsylvania](/blog/pennsylvania-seller-disclosure-requirements-2026), but that perceived simplicity can breed complacency. Agents who treat the form as a checkbox exercise rather than a liability shield expose themselves, their brokerages, and their clients to avoidable risk.
...
|---|---|---|
| Standard owner-occupied residential sale | Yes | NDCC 47-10-02.1 |
| Foreclosure or deed in lieu | No | NDCC 47-10-02.1(2)(a) |
| Court-ordered sale (probate, partition) | No | NDCC 47-10-02.1(2)(b) |
| Transfer between co-owners | No | NDCC 47-10-02.1(2)(c) |
| Transfer by government entity | No | NDCC 47-10-02.1(2)(d) |
| New construction (never occupied) | No | NDCC 47-10-02.1(2)(e) |
| Sale by licensed real estate auction | Still required unless another exemption applies | General rule |
...
The [real cost of missed deadlines](/blog/real-cost-of-missed-deadlines) goes beyond a single unwound deal. A pattern of late disclosure delivery can trigger a NDREC audit, and repeated violations may result in license suspension.
...
|---|---|---|
| Disclosure form presence in file | Signed copy of NDREC Form 2 present before closing | Every transaction |
| Completeness review | No blank lines; all sections addressed | Every transaction |
| Delivery timing documentation | Date-stamped delivery confirmation or buyer acknowledgment | Every transaction |
| Exemption verification | Written documentation supporting claimed exemption | Each exempt transaction |
| Supplemental disclosure tracking | Updated forms if seller reports new conditions | As needed |

Brokers should implement a file review checkpoint at the contract-acceptance stage—not at closing. Catching a missing or incomplete disclosure two days before closing forces rushed corrections and increases the chance of errors. A structured transaction management process, similar to what agents handling [multiple active deals](/blog/track-multiple-active-deals) already need, ensures nothing falls through.
...
Minnesota requires a much more detailed form with specific questions about radon, methamphetamine production, and neighborhood nuisances. South Dakota, by contrast, has [its own disclosure statute](/blog/south-dakota-seller-disclosure-requirements-2026) with a different exemption structure. Montana requires disclosures but grants a [broader set of exemptions](/blog/montana-seller-disclosure-requirements-2026) for agricultural land transfers.
