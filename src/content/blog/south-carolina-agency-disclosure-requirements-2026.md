---
title: "South Carolina Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "South Carolina agency disclosure requirements 2026 explained with specific forms, statutes, common mistakes, and broker audit checklists for full compliance."
...
tags: ["agency-disclosure-requirements", "south-carolina", "compliance"]
keywords: ["South Carolina agency disclosure requirements 2026", "south carolina real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in South Carolina?"
    a: "You must provide the SC agency disclosure (Form 500) at the earliest practical opportunity but no later than the time you begin providing brokerage services to a client or customer."
  - q: "What happens if I forget to give agency disclosure in SC?"
    a: "Failure to provide timely agency disclosure can result in disciplinary action by the SC Real Estate Commission, including fines up to $1,000 per violation, license suspension, and potential voidability of the transaction."
  - q: "Do I need a new agency disclosure for dual agency in South Carolina?"
    a: "Yes. Dual agency requires separate, written informed consent from both the buyer and seller before you act as a dual agent. The standard Form 500 alone is not sufficient for dual agency authorization."
  - q: "Who is responsible for keeping agency disclosure forms on file in SC?"
    a: "The broker-in-charge is responsible for maintaining all agency disclosure documents in the transaction file for a minimum of five years after the transaction closes or terminates."
---
...
**The statute distinguishes between three agency relationships: seller's agent, buyer's agent, and dual agent.** Each has distinct disclosure obligations, and dual agency carries the additional requirement of written informed consent from all parties. South Carolina does not recognize designated agency in the way some neighboring states do—this is a common source of confusion for agents who have practiced in [North Carolina](/blog/north-carolina-agency-disclosure-requirements-2026) or [Virginia](/blog/virginia-agency-disclosure-requirements-2026).
...
Third: using outdated forms. The SCREC periodically updates its prescribed forms, and agents who rely on old templates from their document management system risk submitting forms that no longer meet statutory requirements. Always verify that your forms match the [current versions posted by the Commission](https://llr.sc.gov/re/).
...
If you are managing more than a handful of active deals at once, the operational complexity of tracking disclosure timing across multiple agents becomes significant. This is where deadline-tracking systems and [workflow tools that monitor multiple active deals](/blog/track-multiple-active-deals) become essential rather than optional. [Missing deadlines](/blog/real-cost-of-missed-deadlines) on agency disclosure is not like missing a home inspection contingency date—it is a regulatory violation every single time.
