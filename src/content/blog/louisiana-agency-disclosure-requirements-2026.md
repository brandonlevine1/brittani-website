---
title: "Louisiana Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Louisiana agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make in residential transactions."
...
tags: ["agency-disclosure-requirements", "louisiana", "compliance"]
keywords: ["Louisiana agency disclosure requirements 2026", "louisiana real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Louisiana?"
    a: "You must provide the Dual Agency Disclosure and Consent Form before or at the time you begin acting as a dual agent. For general agency relationships, disclosure is required at the first substantive contact with a consumer."
  - q: "What form do Louisiana agents use for agency disclosure?"
    a: "Louisiana agents use the LREC Form 2-A (Dual Agency Disclosure and Consent) and follow the disclosure framework outlined in Louisiana Revised Statutes Title 37, Chapter 16, particularly La. R.S. 37:1455."
  - q: "What happens if I forget to disclose dual agency in Louisiana?"
    a: "Failure to disclose dual agency can result in LREC disciplinary action including fines up to $2,000 per violation, license suspension, and potential deal rescission by either party."
  - q: "Do I need written consent for designated agency in Louisiana?"
    a: "Yes. Under La. R.S. 37:1455(B), both the buyer and seller must give written informed consent before a broker can appoint designated agents within the same firm to represent opposing parties."
---

## Understanding Louisiana Agency Disclosure Requirements 2026

Louisiana handles agency relationships differently than many states, and agents who carry habits from other jurisdictions—or who simply haven't reviewed their obligations recently—risk disciplinary action and deal collapse. The Louisiana agency disclosure requirements 2026 framework is governed primarily by Louisiana Revised Statutes Title 37, Chapter 16 (La. R.S. 37:1431 et seq.), with enforcement handled by the [Louisiana Real Estate Commission (LREC)](https://www.lrec.louisiana.gov/). Understanding the specific timing, forms, and consent obligations isn't optional. It's the baseline for practicing legally in this state.
...
The stakes here are real. A single missed disclosure can trigger a complaint that puts your license under review, creates liability exposure for your brokerage, and gives a disgruntled party grounds to unwind a closed deal. If you're managing [multiple active deals](/blog/track-multiple-active-deals) simultaneously, the risk of a procedural slip multiplies with each file.
...
**Brokers should implement a pre-contract checklist that requires agents to upload executed disclosure documents before the file advances to the contract stage.** This single gatekeeping step prevents the most common failure mode: agents who intend to disclose but get caught up in negotiation momentum and forget until it's too late. If your [transaction processes break down](/blog/where-deals-break-down) at predictable points, disclosure timing is likely one of them.
...
Unlike [Texas's agency disclosure framework](/blog/texas-agency-disclosure-requirements-2026), which uses the Information About Brokerage Services form (IABS) at first substantive dialogue, Louisiana does not prescribe a single universal disclosure form for all agency types. Instead, the general disclosure obligation is statutory, with the LREC mandating specific forms only for dual and designated agency situations. This means agents must understand the law itself—not just fill in a form—to comply correctly.

Compared to [Virginia's agency disclosure structure](/blog/virginia-agency-disclosure-requirements-2026), Louisiana places greater emphasis on the broker's supervisory role. Virginia requires disclosure at first substantive contact as well, but Louisiana's broker liability provisions are more explicit, creating personal exposure for managing brokers who fail to audit their agents' files.
