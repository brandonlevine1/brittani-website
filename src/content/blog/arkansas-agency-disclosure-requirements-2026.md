---
title: "Arkansas Agency Disclosure Requirements 2026: What Every Agent Must File and When"
description: "Arkansas agency disclosure requirements 2026 explained with form numbers, deadlines, and penalties. Stay compliant and protect your license."
...
tags: ["agency-disclosure-requirements", "arkansas", "compliance"]
keywords: ["Arkansas agency disclosure requirements 2026", "arkansas real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Arkansas?"
    a: "You must provide the agency disclosure at the earliest practical opportunity, which Arkansas Real Estate Commission rules interpret as your first substantive contact with a buyer or seller—before any confidential information is exchanged."
  - q: "What form do Arkansas agents use for agency disclosure?"
    a: "Arkansas agents use AREC Form AD-1 (Agency Disclosure and Consent form), which must be signed by all parties and retained for a minimum of five years."
  - q: "What happens if I forget to give the agency disclosure in Arkansas?"
    a: "Failure to provide timely agency disclosure can result in AREC disciplinary action including fines up to $2,500 per violation, license suspension, and potential voidability of the transaction if a party claims they were misled about representation."
  - q: "Do I need a new disclosure form for dual agency in Arkansas?"
    a: "Yes. If dual agency arises after initial disclosure was made, you must obtain separate written consent from both buyer and seller using the dual agency consent section of AREC Form AD-1 before proceeding."
---
...
The distinction matters because Arkansas does not follow the same agency framework as neighboring states like [Oklahoma](/blog/oklahoma-agency-disclosure-requirements-2026) or [Tennessee](/blog/tennessee-agency-disclosure-requirements-2026). Arkansas still permits disclosed dual agency with written consent, and it offers the transaction licensee option for agents who want to facilitate a deal without representing either party.
...
| Requirement | Details |
|---|---|
| Primary form | AREC Form AD-1 |
| Timing | First substantive contact |
| Signatures required | Agent and all parties to the relationship |
| Retention period | Minimum 5 years per AREC Rule 10.9 |
| Dual agency consent | Separate written consent section on AD-1 |
| Transaction licensee election | Must be disclosed on AD-1 before services begin |
...
AREC publishes updated forms on its [official website](https://www.arec.arkansas.gov/), and agents should verify they are using the current version at the start of each year. Using an outdated form version is a citable offense during an audit.
...
|---|---|---|
| Timing verification | Date on AD-1 vs. first showing date | AD-1 dated same day as contract |
| Signature completeness | All parties signed and dated | Missing buyer or seller signature |
| Form version | Current year AREC form | Outdated form number or language |
| Dual agency consent | Separate section completed when applicable | Single-agent disclosure on a dual-agency file |
| Retention | Five-year file retention in place | Files purged before five years |
