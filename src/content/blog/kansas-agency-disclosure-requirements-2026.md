---
title: "Kansas Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Kansas agency disclosure requirements 2026 explained with specific forms, statutes, common mistakes, and broker audit steps for full compliance."
...
tags: ["agency-disclosure-requirements", "kansas", "compliance"]
keywords: ["Kansas agency disclosure requirements 2026", "kansas real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Kansas?"
    a: "You must provide the agency disclosure at the first substantive contact with a prospective buyer or seller, before any confidential information is shared. This is required by K.S.A. 58-30,106."
  - q: "What form number do Kansas agents use for agency disclosure?"
    a: "Kansas agents use the KREC-approved Agency Disclosure and Informed Consent to Dual Agency form, commonly referenced as the KREC Form 100. Brokerages may also use Kansas Association of Realtors Form 110 for the agency election."
  - q: "What happens if I forget to give the agency disclosure in Kansas?"
    a: "Failure to disclose can result in KREC disciplinary action including fines up to $5,000 per violation, license suspension, and civil liability that may allow a buyer or seller to rescind the transaction."
  - q: "Do I need a new agency disclosure for every property I show a buyer?"
    a: "No. A single agency disclosure covers your relationship with that buyer across all properties, but you must provide a separate Informed Consent to Dual Agency form if dual agency arises on a specific transaction."
---
...
This matters more in 2026 than ever because KREC has increased its audit frequency following the [NAR settlement changes](/blog/nar-settlement-year-one) that reshaped buyer representation across the country. Kansas agents operating under the old assumption that agency disclosure is a formality are exposing themselves and their brokers to serious risk.
...
|------|---------|--------|-----------------|
| KREC Form 100 | Agency disclosure and dual agency consent | First substantive contact | Agent and consumer |
| KAR Form 110 | Agency election/confirmation | At or before agency agreement | Agent and consumer |
| KREC Form 100 (dual agency section) | Informed consent to dual agency | Before dual agency begins | Both buyer and seller |
| Brokerage office policy form | Internal documentation of company policy | Agent onboarding | Agent and broker |
...
Your brokerage may have a branded version of these forms, but stripping out required statutory language to make the form "cleaner" or "simpler" is a compliance violation. Always verify that your forms match the current [KREC model language](https://krec.ks.gov/).
...
|------------|-----------|---------------|----------|
| Agency disclosure presence in file | Every transaction | Signed form dated before or at first substantive contact | Missing signature, date after contract execution |
| Dual agency consent | Every in-house transaction | Separate consent form with both parties' signatures | Only one party signed, or consent form is absent |
| Designated agency documentation | Applicable transactions | Written designation of separate agents | No written designation, same agent named on both sides |
| Form version | Quarterly | Compare to current KREC model language | Outdated statutory language, missing required paragraphs |
| Agent training records | Annually | CE completion and internal compliance training | No evidence of disclosure training since licensure |

**Brokers should build a file review checklist that flags agency disclosure as a day-one compliance item, not a closing-day afterthought.** If your transaction coordinators or administrative staff review files, they must be trained to identify whether the disclosure date predates or coincides with first substantive contact. A [monthly compliance audit](/blog/monthly-compliance-audit) framework eliminates the guesswork and prevents violations from compounding across multiple deals.
