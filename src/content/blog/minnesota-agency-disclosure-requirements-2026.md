---
title: "Minnesota Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Minnesota agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make. Stay compliant."
...
tags: ["agency-disclosure-requirements", "minnesota", "compliance"]
keywords: ["Minnesota agency disclosure requirements 2026", "minnesota real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Minnesota?"
    a: "You must present the Agency Relationships in Real Estate Transactions disclosure at the first substantive contact with a prospective buyer or seller, before any confidential information is exchanged. This is required under Minnesota Statutes Section 82.67."
  - q: "What happens if I forget to provide an agency disclosure in Minnesota?"
    a: "Failure to disclose can result in disciplinary action by the Minnesota Department of Commerce, including fines, license suspension, or revocation. It can also give the non-disclosing party's client grounds to rescind the transaction."
  - q: "Do I need a separate disclosure for dual agency in Minnesota?"
    a: "Yes. Minnesota Statutes Section 82.67 requires written informed consent from both parties before an agent or brokerage can act as a dual agent. This consent must be documented on a separate dual agency agreement, not just acknowledged on the initial disclosure form."
  - q: "Who is responsible for keeping agency disclosure forms on file—the agent or the broker?"
    a: "The broker is ultimately responsible for maintaining all agency disclosure records for at least six years, per Minnesota Department of Commerce record-retention rules. Individual agents should keep their own copies as well."
---
...
|------|---------|----------------|
| Agency Relationships Disclosure (MNAR Form) | Explains all available agency types | First substantive contact |
| Buyer Representation Agreement | Establishes buyer agency | Before showing properties or submitting offers |
| Dual Agency Consent | Authorizes dual agency | Before dual representation begins |
| Facilitator Disclosure | Establishes non-agency facilitator status | At first substantive contact if agent is not representing either party |
...
| Consequence | Details |
|-------------|---------|
| Administrative fine | Up to $10,000 per violation under the Commerce Department's enforcement powers |
| License suspension | Temporary removal of license pending hearing |
| License revocation | Permanent loss of licensure for egregious or repeated violations |
| Transaction rescission | The aggrieved party may have grounds to cancel the purchase agreement |
| Civil liability | Actual damages plus potential attorney's fees in a private lawsuit |
...
The Department of Commerce publishes enforcement actions on its [website](https://mn.gov/commerce/licensees/), and real estate-specific disciplinary records are searchable by the public. A single disclosure violation can follow your career for years.
...
Brokers operating larger teams should implement a compliance calendar. The [training new agents on timelines](/blog/training-new-agents-timelines) process must include agency disclosure timing as a non-negotiable checkpoint. New licensees are disproportionately likely to mishandle disclosure because they confuse eagerness to help with actually establishing a relationship.
...
Agents licensed in multiple states often assume their home-state practices transfer cleanly. They do not. Minnesota's facilitator status, for example, operates differently from [Wisconsin's agency disclosure structure](/blog/wisconsin-agency-disclosure-requirements-2026) and from [Missouri's designated agency model](/blog/missouri-agency-disclosure-requirements-2026). Each state defines the available relationships, the timing of disclosure, and the duties owed under each relationship in its own way.

| Element | Minnesota | Wisconsin | Missouri |
|---------|-----------|-----------|----------|
| Facilitator/Transaction Broker | Yes (statutory) | No (not recognized) | Yes (designated agent model) |
| Timing of disclosure | First substantive contact | First meeting or contact | Before providing services |
| Dual agency | Permitted with written consent | Permitted with written consent | Permitted with informed consent |
| State-mandated form | No (MNAR forms are standard) | Yes (DSPS-approved form) | No (standard forms via MAR) |
