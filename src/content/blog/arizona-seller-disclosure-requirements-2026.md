---
title: "Arizona Seller Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Arizona seller disclosure requirements 2026 explained with specific statutes, form numbers, and liability risks every agent needs to know."
...
tags: ["seller-disclosure-requirements", "arizona", "compliance"]
keywords: ["Arizona seller disclosure requirements 2026", "arizona real estate compliance", "seller disclosure requirements"]
type: "regulatory"
---
...
Training is the second enforcement lever. Brokers who offer annual CE or office training on disclosure obligations—particularly walking through recent ADRE disciplinary actions—create a documented culture of compliance. That documentation becomes a defense asset if a single agent's failure results in a claim against the brokerage. The [ADRE's public disciplinary database](https://azre.gov/) is a free resource for pulling real examples into training sessions.
...
Arizona law imposes disclosure requirements that exist outside the SPDS form itself. The state's [community facilities district](/blog/arizona-cfd-disclosure-requirements) rules require sellers to disclose if the property is within a CFD that levies special taxes. Military airport and public airport disclosure requirements under A.R.S. 28-8486 apply to properties within specific noise contours or accident potential zones.

Environmental disclosures—particularly regarding [ADEQ-listed contamination sites](https://azdeq.gov/)—can apply even when the seller is unaware if the agent has access to public records identifying the issue. The standard of care for agents increasingly includes checking readily available public databases, and ADRE investigations have cited agents for failing to check resources that any competent licensee would consult.
