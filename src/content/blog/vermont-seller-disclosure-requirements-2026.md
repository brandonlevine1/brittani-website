---
title: "Vermont Seller Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Vermont seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, common errors, and liability risks you need to know."
...
tags: ["seller-disclosure-requirements", "vermont", "compliance"]
keywords: ["Vermont seller disclosure requirements 2026", "vermont real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to provide a seller disclosure form in Vermont if the property is sold as-is?"
    a: "Yes. Vermont law requires the Property Information Report regardless of as-is language in the contract. The seller must still disclose known material defects under 27A V.S.A. Chapter 3."
  - q: "What form do Vermont agents use for seller disclosures?"
    a: "The standard form is the Vermont Property Information Report, sometimes referenced as the PIR, which is required by 27A V.S.A. § 302. Most agents use the version published by the Vermont Association of Realtors."
  - q: "What happens if a Vermont seller refuses to fill out the disclosure form?"
    a: "The buyer must be notified in writing that the seller has declined to provide the report. The buyer then has the right to rescind the purchase contract within a specified period, typically before closing."
  - q: "Who is liable if a material defect is not disclosed in Vermont—the agent or the seller?"
    a: "Primary liability falls on the seller, but a listing agent who knew or should have known about a defect and failed to disclose it can face disciplinary action from the Vermont Real Estate Commission and civil liability."
---
...
|----------|--------------|
| PIR delivered before contract signing | No rescission right based on late delivery |
| PIR delivered after contract signing | Buyer may rescind within 3 business days of receipt |
| PIR never delivered | Buyer may rescind any time before closing |
| Seller refuses to complete PIR | Buyer must be notified; rescission right applies |

This rescission right is not theoretical. Deals do fall apart over late or missing disclosures, and agents who [miss critical deadlines](/blog/real-cost-of-missed-deadlines) in the disclosure process may face client complaints and commission disputes. The safest practice is to have the completed PIR in hand before listing the property or, at minimum, before a purchase contract is presented.

## Agent and Broker Liability for Non-Compliance

Vermont does not treat disclosure failures as mere paperwork oversights. Under [Vermont Real Estate Commission rules](https://sos.vermont.gov/real-estate/), a licensee who assists a seller in concealing a material defect, or who fails to disclose a defect the licensee personally knows about, may face disciplinary proceedings including fines, license suspension, or revocation.
...
|------------|-----------|---------------|
| PIR completion | Every listing | All fields answered; no blanks left unsigned |
| PIR delivery timestamp | Before contract ratification | Documented proof of delivery to buyer or buyer's agent |
| Lead paint disclosure | Pre-1978 properties | Separate federal form completed and signed by all parties |
| Supplemental disclosures | As needed | Any new defects disclosed in writing before closing |
| Exemption documentation | Exempt transactions | Written basis for exemption on file |

**Brokers should build a disclosure audit into their transaction review process, not treat it as an afterthought at closing.** If your office handles volume, this is exactly where operational tools become essential. Tracking [multiple active deals](/blog/track-multiple-active-deals) without a system that flags missing disclosures is a liability waiting to materialize.

Quarterly file reviews should specifically check whether PIRs were delivered before contract execution, whether supplemental disclosures were issued when inspection reports revealed new issues, and whether exempt transactions have a written memo explaining the basis for exemption. Agents resist paperwork, and [that resistance costs real money](/blog/why-agents-hate-paperwork) when a Commission complaint arrives.

## How Vermont Compares to Neighboring States

Vermont's approach sits in the middle of the New England spectrum. New Hampshire, for example, has a more limited [seller disclosure framework](/blog/new-hampshire-seller-disclosure-requirements-2026) that relies on a shorter form and fewer mandatory categories. New York requires a Property Condition Disclosure Statement but allows sellers to pay a $500 credit to the buyer in lieu of completing it—an option Vermont does not offer.
