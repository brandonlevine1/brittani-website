---
title: "Georgia Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Georgia agency disclosure requirements 2026 explained for agents and brokers—statutes, forms, penalties, and common mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "georgia", "compliance"]
keywords: ["Georgia agency disclosure requirements 2026", "georgia real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Georgia?"
    a: "You must provide the Brokerage Relationships in Real Estate Transactions disclosure at the earliest practical time but no later than the point you begin providing brokerage services or showing property."
  - q: "What form number is the Georgia agency disclosure?"
    a: "The Georgia Association of Realtors form GAR F201 is the standard agency disclosure form used alongside the statutory exhibit required under O.C.G.A. 10-6A-12."
  - q: "What happens if I forget to give a client the agency disclosure in Georgia?"
    a: "Failure to disclose can trigger disciplinary action by the Georgia Real Estate Commission, possible license suspension or revocation, and may give the aggrieved party grounds to rescind the transaction or pursue civil damages."
  - q: "Do I need a new disclosure for every property I show in Georgia?"
    a: "No. A single disclosure at the beginning of the brokerage relationship covers all subsequent showings under that relationship, but you must confirm agency status before drafting or presenting any offer on a specific property."
---
...
BRRETA governs all agency relationships in Georgia residential real estate transactions. The act defines the duties owed by a broker to clients versus customers and mandates written disclosure of those relationships. The [full text of O.C.G.A. 10-6A](https://www.grec.state.ga.us/information-research/license-law/) is available on the GREC website, and every licensee should review the current version annually.
...
| Element | GAR F201 Requirement | BRRETA Statutory Minimum |
|---------|---------------------|--------------------------|
| Types of agency listed | All four (seller's, buyer's, designated, transaction broker) | All types authorized by the act |
| Consumer signature | Required on form | Written acknowledgment required |
| Timing of delivery | Before brokerage services begin | At earliest practical time |
| Retention period | Per brokerage policy (recommend 5 years) | No specific statutory minimum, but GREC audits look for 3+ years |
| Dual agency consent | Separate written consent section | Informed written consent from both parties |
...
Fourth, teams operating under a single broker often fail to designate which agent within the team holds the agency relationship. GREC expects clear designation, especially when a team has both the listing and a buyer lead. Without proper [designation and documentation](/blog/where-deals-break-down), the brokerage risks an undisclosed dual-agency scenario.

Fifth, agents relocating from other states assume their prior state's timing rules apply. Georgia's "earliest practical time" standard differs from states that set a fixed calendar trigger. If you are used to a different framework—like [New York's disclosure timing](/blog/new-york-agency-disclosure-requirements-2026) or [Ohio's specific rules](/blog/ohio-agency-disclosure-requirements-2026)—you must adjust to Georgia's fact-specific standard immediately.
...
| Violation Severity | Typical GREC Response | Potential Civil Exposure |
|---|---|---|
| Late disclosure, no harm | Citation, fine ($500–$1,500), continuing education | Minimal unless consumer complains |
| Missing disclosure discovered during transaction | Consent order, fine ($1,000–$2,500), possible deal rescission | Buyer or seller may seek rescission or damages |
| Undisclosed dual agency | Suspension (30–180 days), fine ($2,500–$5,000) | Rescission plus compensatory damages |
| Pattern of non-disclosure | Revocation proceedings | Brokerage E&O claims, potential fraud allegations |
...
Transaction coordinators play a critical role here. If your TC is not flagging [missing deadlines and paperwork](/blog/real-cost-of-missed-deadlines) at intake, your brokerage is relying on individual agents to self-police—a model that GREC enforcement data proves fails repeatedly.
