---
title: "South Dakota Seller Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "South Dakota seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, liability risks, and common compliance mistakes to avoid."
...
tags: ["seller-disclosure-requirements", "south-dakota", "compliance"]
keywords: ["South Dakota seller disclosure requirements 2026", "south dakota real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need a seller disclosure form for every residential sale in South Dakota?"
    a: "Yes, unless an exemption applies under SDCL 43-4-44. Most exemptions involve court-ordered transfers, foreclosures, or transfers between family members. Standard residential resales require the statutory disclosure statement."
  - q: "What happens if my seller refuses to fill out the disclosure form?"
    a: "Buyers may cancel the purchase agreement without penalty if a seller fails to deliver the disclosure within the statutory timeframe. The seller cannot simply skip it—agents should document the refusal and advise the seller of legal exposure."
  - q: "How long does the buyer have to rescind after receiving the disclosure?"
    a: "Under SDCL 43-4-41, the buyer has two business days after receipt of the seller's disclosure statement to rescind the offer without forfeiting earnest money."
  - q: "Who is liable if a material defect is not disclosed in South Dakota?"
    a: "The seller bears primary liability, but a listing agent who knew or should have known about an undisclosed defect may also face disciplinary action from the SDREC and civil claims from the buyer."
---
...
South Dakota does not publish a single state-mandated disclosure form in the way that, say, [Oregon does with its statutory form](/blog/oregon-seller-disclosure-requirements-2026). Instead, the SDREC references the [South Dakota Association of REALTORS (SDAR) Seller's Property Condition Disclosure Statement](https://www.sdrec.sd.gov/) as the industry-standard form that satisfies the statutory requirements. Most MLS systems across the state—including those operated by the Sioux Falls Area Association of REALTORS and the Black Hills Association of REALTORS—accept this form.
...
For a deeper look at how Montana handles its statutory form differently, see [Montana seller disclosure requirements 2026](/blog/montana-seller-disclosure-requirements-2026). The comparison is useful for agents working the western SD corridor.
