---
title: "Mississippi Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Mississippi agency disclosure requirements 2026 explained for agents and brokers—specific forms, deadlines, penalties, and common compliance errors to avoid."
...
tags: ["agency-disclosure-requirements", "mississippi", "compliance"]
keywords: ["Mississippi agency disclosure requirements 2026", "mississippi real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to give agency disclosure before showing a house in Mississippi?"
    a: "Yes. Mississippi law requires that agents provide the Consumer Agency Disclosure pamphlet at the first substantial contact, which typically occurs before or during a property showing."
  - q: "What form do Mississippi agents use for agency disclosure?"
    a: "Agents use MREC Form 1, the Consumer Agency Disclosure pamphlet, which must be presented and acknowledged in writing by the consumer."
  - q: "What happens if I forget to give the agency disclosure in Mississippi?"
    a: "Failure to disclose can result in MREC disciplinary action including fines up to $1,000 per violation, license suspension, and potential civil liability that could void a contract."
  - q: "Who is responsible for agency disclosure compliance—the agent or the broker?"
    a: "Both are responsible. The agent must present the disclosure at the correct time, and the supervising broker must maintain records and audit compliance under Mississippi Code Section 73-35-3."
---
...
Many agents from other states assume disclosure timing aligns with their prior experience. Mississippi's standard differs materially from neighboring states like [Tennessee](/blog/tennessee-agency-disclosure-requirements-2026) and [Texas](/blog/texas-agency-disclosure-requirements-2026), where disclosure windows and form structures vary.
...
Fifth, agents rely on outdated forms. MREC periodically updates Form 1 language to reflect statutory changes and commission interpretations. Using a version from three years ago may omit required language about transaction brokerage or updated duty descriptions. Always pull the current version from the [MREC official website](https://www.mrec.ms.gov/).
...
Tracking these requirements across even a handful of active files becomes unwieldy without a system. Agents juggling [multiple active deals](/blog/track-multiple-active-deals) are statistically more likely to miss disclosure deadlines, which is why systematic tracking matters more than good intentions.
...
The 2024 NAR settlement changes have increased confusion around buyer representation, making these distinctions more critical in 2026. For agents adapting to new compensation structures while maintaining proper agency disclosure, [understanding the practical implications of the NAR settlement one year later](/blog/nar-settlement-year-one) provides necessary context.
