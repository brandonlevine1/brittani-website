---
title: "Pennsylvania Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Pennsylvania agency disclosure requirements 2026 explained for agents and brokers—forms, deadlines, penalties, and common compliance mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "pennsylvania", "compliance"]
keywords: ["Pennsylvania agency disclosure requirements 2026", "pennsylvania real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the Consumer Notice in Pennsylvania?"
    a: "You must provide the Consumer Notice at the initial interview—the first substantive contact with a consumer about their real estate needs—before any confidential information is shared."
  - q: "What happens if I forget to give the agency disclosure in PA?"
    a: "Failure to provide the Consumer Notice can result in disciplinary action by the Pennsylvania State Real Estate Commission, including fines up to $10,000 per violation, license suspension, and potential civil liability if a consumer is harmed."
  - q: "Do I need a signed Consumer Notice for every open house visitor in Pennsylvania?"
    a: "No, but you must provide the Consumer Notice before any substantive discussion about a visitor's specific real estate needs. Casual conversation at an open house does not trigger the requirement, but the moment you begin discussing their buying criteria or financial situation, it does."
  - q: "Can a Pennsylvania agent represent both buyer and seller in the same transaction?"
    a: "Yes, but only as a dual agent with informed written consent from both parties. The agent must explain the limitations on confidentiality and advocacy before either party agrees to dual agency."
---
...
Consider building a compliance workflow that flags when an agent adds a new contact to your CRM or transaction management platform without an attached Consumer Notice. This is exactly the kind of operational discipline that separates brokerages facing disciplinary hearings from those that pass audits cleanly. If your team handles [multiple active deals simultaneously](/blog/track-multiple-active-deals), systematizing this checkpoint becomes non-negotiable.
