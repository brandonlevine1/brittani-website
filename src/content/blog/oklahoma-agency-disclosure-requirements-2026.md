---
title: "Oklahoma Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Oklahoma agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make. Stay compliant."
...
tags: ["agency-disclosure-requirements", "oklahoma", "compliance"]
keywords: ["Oklahoma agency disclosure requirements 2026", "oklahoma real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Oklahoma?"
    a: "You must provide the Disclosure of Agency Relationships form at the first substantive contact with a buyer or seller, before any confidential information is exchanged. The Oklahoma Real Estate Commission defines substantive contact as any discussion that goes beyond general market information."
  - q: "What form number is the Oklahoma agency disclosure?"
    a: "The Oklahoma Real Estate Commission prescribes Form REL-100 (Disclosure of Agency Relationships) and Form REL-200 (Confirmation of Agency Relationship). Both must be in the transaction file."
  - q: "What happens if I forget to give the agency disclosure in Oklahoma?"
    a: "Failure to disclose can trigger disciplinary action by OREC including fines up to $1,000 per violation, license suspension, and potential deal rescission by the aggrieved party under Title 59 O.S. Section 858-354."
  - q: "Do I need a new agency disclosure for every transaction in Oklahoma?"
    a: "Yes. Each transaction requires its own completed and signed disclosure forms. A blanket disclosure from a prior deal does not satisfy the statutory requirement."
---
...
| Form | Full Name | When Required | Who Signs |
|------|-----------|---------------|-----------|
| REL-100 | Disclosure of Agency Relationships | First substantive contact | Consumer (acknowledgment) |
| REL-200 | Confirmation of Agency Relationship | Before or at offer preparation | All parties and agents |
| Broker Engagement Agreement | Varies by brokerage | At establishment of agency | Client and broker |
...
Oklahoma's framework differs from neighboring states. In [Texas](/blog/texas-agency-disclosure-requirements-2026), for instance, the Information About Brokerage Services form has slightly different triggering events. And [Ohio's approach](/blog/ohio-agency-disclosure-requirements-2026) to agency confirmation operates on its own timeline. Oklahoma agents who also hold licenses in bordering states need to keep these distinctions clear in their workflow.
...
|------------|---------------|-----------|
| REL-100 in file | Present, signed, dated before substantive contact | Every transaction |
| REL-200 in file | Present, signed, dated before or at offer | Every transaction |
| Dual agency consent | Both parties signed, explanation documented | Dual agency files |
| Transaction broker election | REL-200 reflects TB status, consumer acknowledged | TB transactions |
| Team member identification | Individual licensee named on all forms | Team transactions |
