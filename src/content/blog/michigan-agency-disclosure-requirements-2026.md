---
title: "Michigan Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Michigan agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make. Stay compliant and protect your license."
...
tags: ["agency-disclosure-requirements", "michigan", "compliance"]
keywords: ["Michigan agency disclosure requirements 2026", "michigan real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to provide the agency disclosure form in Michigan?"
    a: "You must provide the agency disclosure at the first substantive contact with a buyer or seller, before any confidential information is exchanged. This is required under MCL 339.2512d."
  - q: "What form do Michigan agents use for agency disclosure?"
    a: "Michigan agents use the Michigan Association of Realtors form, commonly referenced as the Agency Disclosure form (MAR form), which satisfies the requirements of the Occupational Code Article 25."
  - q: "What happens if I forget to give the agency disclosure in Michigan?"
    a: "Failure to provide the disclosure can result in disciplinary action by the Michigan Department of Licensing and Regulatory Affairs, including fines up to $10,000 per violation, license suspension, and potential deal rescission by the aggrieved party."
  - q: "Do I need a new agency disclosure for every transaction in Michigan?"
    a: "Yes. A separate agency disclosure must be provided for each transaction, even if you have worked with the same client before. Prior disclosures do not carry over."
---
...
| Form/Document | Purpose | When Provided |
|---|---|---|
| Agency Disclosure (MAR) | Establishes and documents the specific agency relationship | First substantive contact |
| Disclosure Regarding Real Estate Agency Relationships | Educates consumer on types of agency available | First substantive contact or before |
| Dual Agency Consent | Obtains written consent for dual agency | Before acting as dual agent |
| Designated Agent Disclosure | Identifies specific agents in a brokerage representing each party | When brokerage designates agents |
...
| Consequence | Severity | Who Initiates |
|---|---|---|
| Fine up to $10,000 per violation | Regulatory | LARA Bureau of Professional Licensing |
| License suspension or revocation | Regulatory | LARA after hearing |
| Contract rescission | Transactional | Aggrieved party |
| Civil damages lawsuit | Civil | Buyer or seller |
| E&O claim denial | Financial | Insurance carrier |

Understanding these penalties should motivate compliance, but knowing the [real cost of missed deadlines](/blog/real-cost-of-missed-deadlines) in broader transaction management helps put the financial risk into full perspective.
...
The [training new agents on timelines](/blog/training-new-agents-timelines) process should include specific modules on disclosure timing, form selection, and record retention. New licensees often receive minimal practical training on agency disclosure during pre-licensing education, and the gap between textbook knowledge and real-world execution is where violations breed.
