---
title: "Oregon Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Oregon agency disclosure requirements 2026 explained for licensed agents—specific forms, deadlines, liability risks, and broker audit steps."
...
tags: ["agency-disclosure-requirements", "oregon", "compliance"]
keywords: ["Oregon agency disclosure requirements 2026", "oregon real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure pamphlet in Oregon?"
    a: "You must provide the Initial Agency Disclosure Pamphlet at the first contact where you discuss a specific property or the client's specific needs, but no later than the first substantive professional contact per ORS 696.810."
  - q: "What form do Oregon agents use for agency disclosure?"
    a: "Oregon agents use the Oregon Real Estate Agency Disclosure Pamphlet required under ORS 696.800–696.830, and the Disclosed Limited Agency Agreements form when representing both parties with informed consent."
  - q: "What happens if I forget to give the buyer the agency disclosure in Oregon?"
    a: "Failure to deliver the pamphlet can result in disciplinary action by the Oregon Real Estate Agency, rescission of the transaction by the aggrieved party, and potential civil liability for damages under ORS 696.810(3)."
  - q: "Can an Oregon agent represent both buyer and seller?"
    a: "Yes, but only as a disclosed limited agent with written, informed consent from both parties. The agent must explain the limitations on duties, and both clients must sign an acknowledgment before the dual representation begins."
---
...
For a deeper comparison, see our breakdown of [Washington agency disclosure requirements](/blog/washington-agency-disclosure-requirements-2026), which highlights the later trigger point Washington permits—a distinction that trips up cross-border agents frequently.
