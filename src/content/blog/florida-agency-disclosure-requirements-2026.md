---
title: "Florida Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Florida agency disclosure requirements 2026 explained with specific forms, statutes, penalties, and common mistakes agents make. Stay compliant."
...
tags: ["agency-disclosure-requirements", "florida", "compliance"]
keywords: ["Florida agency disclosure requirements 2026", "florida real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to disclose agency before showing a property in Florida?"
    a: "Yes. Under Florida Statute 475.278, you must disclose your agency relationship before or at the time of entering into a listing agreement, before showing property, or before discussing confidential information with any party."
  - q: "What happens if I forget to give a buyer the agency disclosure in Florida?"
    a: "Failure to provide the required disclosure can result in disciplinary action by the FREC, including fines up to $5,000 per violation, license suspension, and potential civil liability if the buyer or seller claims they were harmed by the undisclosed relationship."
  - q: "What form do I use for agency disclosure in Florida?"
    a: "Most agents use Florida Realtors Form TRAB (Transaction Broker Notice) or Form SA (Single Agent Notice). The exact form depends on whether you are acting as a transaction broker or single agent."
  - q: "Can I be a dual agent in Florida?"
    a: "No. Florida eliminated dual agency. The state instead uses the transaction broker model under F.S. 475.278(2), which is the default brokerage relationship unless a single agent or no brokerage relationship is established in writing."
---
...
Many agents also confuse agency disclosure with the [seller's property disclosure requirements](/blog/texas-seller-disclosure-requirements-2026), which address the physical condition of the property rather than the relationship between agent and client. These are two entirely separate obligations that happen to land on the same transaction timeline.
