---
title: "Virginia Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Virginia agency disclosure requirements 2026 explained for agents and brokers—specific forms, deadlines, penalties, and common compliance mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "virginia", "compliance"]
keywords: ["Virginia agency disclosure requirements 2026", "virginia real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Virginia?"
    a: "You must provide the disclosure at the earliest practical time, but no later than the point at which you begin providing specific real estate assistance to a client or customer. For most transactions, this means at or before the first substantive contact about a specific property."
  - q: "What form do Virginia agents use for agency disclosure?"
    a: "Virginia agents use the Virginia Real Estate Board's mandated disclosure form as referenced in VAC 18 VAC 135-20-10 et seq. Most brokerages use the Virginia REALTORS form 600, which satisfies the statutory requirement."
  - q: "What happens if I forget to give the agency disclosure in Virginia?"
    a: "Failure to disclose can result in a formal complaint to the Virginia Real Estate Board, fines up to $2,500 per violation, license suspension or revocation, and potential civil liability including rescission of the contract by the aggrieved party."
  - q: "Do I need a new disclosure if I switch from representing the buyer to dual agency?"
    a: "Yes. Any change in the brokerage relationship requires a new written disclosure and the informed written consent of all parties before the licensee can act in the new capacity."
---
...
Agents should treat the [first-year aftermath of the NAR settlement](/blog/nar-settlement-year-one) as a compliance amplifier. Consumers are reading forms more carefully. They are asking questions about who agents represent. A properly timed, clearly written agency disclosure is now also a client-relations tool—not just a regulatory checkbox.
