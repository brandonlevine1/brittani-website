---
title: "Nevada Seller Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Nevada seller disclosure requirements 2026 explained for agents and brokers—statutes, form numbers, liability risks, and common compliance errors to avoid."
...
tags: ["seller-disclosure-requirements", "nevada", "compliance"]
keywords: ["Nevada seller disclosure requirements 2026", "nevada real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to provide a seller disclosure for every residential sale in Nevada?"
    a: "Yes, with limited exceptions. NRS 113.130 requires a Seller's Real Property Disclosure Form for most residential transactions involving 1-4 units. Exemptions include foreclosures, court-ordered sales, and transfers between co-owners."
  - q: "What happens if a Nevada seller refuses to fill out the disclosure form?"
    a: "The buyer may cancel the agreement within the statutory period without penalty. Agents should document the refusal and advise the seller that failure to disclose can result in civil liability under NRS 113.150."
  - q: "How many days does a buyer have to rescind after receiving the disclosure in Nevada?"
    a: "The buyer has 5 calendar days after receiving the completed disclosure to rescind the purchase agreement, per NRS 113.130(4)."
  - q: "Who is liable if the seller lies on the Nevada disclosure form?"
    a: "The seller bears primary liability for misrepresentation. However, agents who knew or should have known about undisclosed defects can face disciplinary action from the Nevada Real Estate Division and civil claims under NRS 645.252."
---
...
Nevada's framework sits in a middle tier of disclosure rigor nationally—stricter than states with caveat emptor traditions, but less prescriptive than states requiring pre-listing inspections. The governing statute is [NRS 113.130](https://www.leg.state.nv.us/nrs/nrs-113.html), enforced by the Nevada Real Estate Division (NRED) under the Department of Business and Industry. Agents must understand both the statutory letter and the Division's interpretive guidance to stay compliant.

If you have worked transactions in other western states like [Utah](/blog/utah-seller-disclosure-requirements-2026) or [Oregon](/blog/oregon-seller-disclosure-requirements-2026), you will notice Nevada's form is shorter but the timing rules are tighter. That combination creates a false sense of simplicity that catches agents off guard every year.
...
| Timing Element | Requirement | Authority |
|---|---|---|
| Delivery to buyer | Before offer or within reasonable time after acceptance | NRS 113.130(2) |
| Buyer rescission window | 5 calendar days after receipt | NRS 113.130(4) |
| HOA resale package delivery | 10 days for buyer review (separate from disclosure) | NRS 116.4109 |
| Amendment to disclosure | As soon as seller discovers new material fact | NRS 113.130(6) |
...
| Audit Point | What Brokers Should Check | Risk If Missed |
|---|---|---|
| Form completion | All sections addressed; no unexplained blanks | Treated as non-delivery; rescission exposure |
| Delivery timestamp | Documented proof of buyer receipt with date | Rescission window dispute; deal cancellation |
| HOA package vs. disclosure | Both tracked separately with distinct deadlines | Dual rescission paths; buyer walkaway |
| Amendment protocol | System to flag material changes during escrow | Post-closing claims; NRED complaint |
| Agent coaching | No evidence of agents advising on content | Unauthorized practice of law; disciplinary action |

Brokers should build compliance checkpoints into their transaction management workflow rather than relying on end-of-deal file reviews. By the time a file reaches the closing coordinator, a missed disclosure delivery is often unrecoverable. If your brokerage is [tracking multiple active deals](/blog/track-multiple-active-deals) without automated compliance triggers, disclosure timing is one of the first things to fall through the cracks.
