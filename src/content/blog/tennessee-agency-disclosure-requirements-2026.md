---
title: "Tennessee Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Tennessee agency disclosure requirements 2026 explained with form numbers, deadlines, and common mistakes that expose agents to liability."
...
tags: ["agency-disclosure-requirements", "tennessee", "compliance"]
keywords: ["Tennessee agency disclosure requirements 2026", "tennessee real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Tennessee?"
    a: "You must present the agency disclosure form at the first substantive contact with a prospective buyer or seller, before any confidential information is shared. Tennessee Code Annotated Section 62-13-403 defines this as the point where you begin discussing specific property needs, finances, or motivation."
  - q: "What happens if I forget to give the disclosure form in Tennessee?"
    a: "Failure to provide the mandated disclosure can result in TREC disciplinary action including fines up to $1,000 per violation, license suspension, and potential civil liability if a party claims they were harmed by undisclosed dual agency or conflicting representation."
  - q: "Do I need a new disclosure form for every property I show a buyer?"
    a: "No. One properly executed Confirmation of Agency Status form covers the entire agency relationship with that client. However, if the agency relationship changes — such as moving from facilitator to exclusive buyer representative — a new form must be signed reflecting the updated status."
  - q: "Who is responsible for keeping the agency disclosure form on file in Tennessee?"
    a: "The broker is ultimately responsible. TREC requires brokers to maintain transaction records including signed agency disclosure forms for a minimum of three years from the date of closing or the termination of the agency relationship."
---
...
This is materially different from states like Ohio, where disclosure timing has different triggers. If you hold licenses in multiple states, review our breakdown of [Ohio's agency disclosure rules](/blog/ohio-agency-disclosure-requirements-2026) to see how timing and form requirements diverge.
...
| Form | TREC Number | When Required | Who Signs |
|------|-------------|---------------|-----------|
| Disclosure and Consent to Represent Multiple Parties | TREC Form 1 | First substantive contact | All parties who may be affected |
| Confirmation of Agency Status | TREC Form 2 | At or before offer presentation | Buyer, seller, and all agents |
| Affiliated Licensee Disclosure | Firm-specific | When agent has personal interest | Agent and client |
...
Third: using outdated forms. TREC periodically updates its forms, and agents who print batches or rely on old PDFs saved to their desktop may be using superseded versions. The [TREC website](https://www.tn.gov/commerce/regboards/trec.html) always hosts the current versions, and agents should verify form currency at least quarterly.
...
Fifth: conflating agency disclosure with the [Tennessee seller disclosure form](/blog/tennessee-seller-disclosure-requirements-2026), which addresses property condition rather than representation relationships. These serve entirely different purposes, and completing one does not excuse the omission of the other.
...
| Violation Type | Potential Consequence | Statutory Basis |
|---------------|----------------------|-----------------|
| First offense, administrative error | Letter of warning or $500 fine | T.C.A. 62-13-312 |
| Repeated failure to disclose | Fine up to $1,000 per violation | T.C.A. 62-13-312(b) |
| Undisclosed dual agency | License suspension (30-180 days) | T.C.A. 62-13-312(b)(14) |
| Material harm to consumer | License revocation | T.C.A. 62-13-312(b)(3) |
| Civil lawsuit by harmed party | Actual damages plus attorney fees | Common law agency liability |
...
For brokerages managing high transaction volumes, the [missed deadlines problem](/blog/real-cost-of-missed-deadlines) extends directly to agency disclosure timing. A file that is 48 hours late on Form 2 is a file that is technically out of compliance — and TREC does not distinguish between "almost on time" and "missed."
