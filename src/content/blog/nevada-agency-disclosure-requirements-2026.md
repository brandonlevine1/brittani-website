---
title: "Nevada Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Nevada agency disclosure requirements 2026 explained with form numbers, deadlines, and liability risks agents face for non-compliance."
...
tags: ["agency-disclosure-requirements", "nevada", "compliance"]
keywords: ["Nevada agency disclosure requirements 2026", "nevada real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Nevada?"
    a: "You must provide the Duties Owed by a Nevada Real Estate Licensee form before showing property to a buyer or before entering a listing agreement with a seller. The statute says 'before any party discloses confidential information.'"
  - q: "What form number is the Nevada agency disclosure?"
    a: "The Nevada Real Estate Division prescribes the 'Duties Owed by a Nevada Real Estate Licensee' form (commonly referenced as the 547 form). Your brokerage may also use the GLVAR or RSAR version that mirrors the statutory language from NRS 645.252."
  - q: "What happens if I forget to give the agency disclosure in Nevada?"
    a: "Failure to disclose can result in disciplinary action by the Nevada Real Estate Division, including fines up to $10,000 per violation, license suspension, and potential deal rescission by the aggrieved party under NRS 645.254."
  - q: "Do I need a separate disclosure for dual agency in Nevada?"
    a: "Yes. Under NRS 645.252(3), you must obtain written, informed consent from both parties before acting as a dual agent. A separate consent form or additional signature block specifically addressing reduced duties is required beyond the initial agency disclosure."
---
...
| Form | Trigger Point | Signature Required | Statutory Basis |
|------|--------------|-------------------|-----------------|
| Duties Owed by a Nevada Real Estate Licensee | Before confidential information is shared | Yes, from all parties | NRS 645.252(1) |
| Consent to Act for Both Parties | Before dual agency commences | Yes, from both buyer and seller | NRS 645.252(3) |
| Confirmation of Representation | At offer presentation (GLVAR/RSAR practice) | Yes, within purchase agreement | Brokerage policy / MLS rules |
...
|------------|-----------|----------|
| Signed Duties Owed form in every file | Every transaction | Missing signature, wrong date, or date after first showing |
| Dual agency consent | Every in-house double-end | No standalone consent form or consent obtained after offer |
| Form version currency | Quarterly | Forms older than current NRED revision date |
| Delivery timing documentation | Random monthly sampling | Agent cannot prove when form was delivered |
| Unrepresented party disclosure | Every transaction with a non-client | No form given to unrepresented buyer or seller |

**Brokers should build a compliance checkpoint into their transaction management workflow, not rely on end-of-deal file reviews.** By the time a transaction coordinator reviews a file at closing, the violation has already occurred and the liability window is open. Agents tracking multiple deals simultaneously benefit from systems that prompt disclosure delivery at the relationship-initiation stage rather than the contract stage. For agents juggling volume, this mirrors the challenge of [tracking multiple active deals](/blog/track-multiple-active-deals) without dropping compliance steps.
...
The post-NAR settlement environment has added scrutiny to dual agency practices nationally. Agents working under the [new compensation structures following the NAR settlement](/blog/nar-settlement-year-one) should be especially careful that dual agency consent forms clearly address compensation arrangements to avoid any appearance of a conflict not disclosed in writing.
...
| Requirement | Nevada | Utah | Texas |
|-------------|--------|------|-------|
| Standalone disclosure form required | Yes | Yes | Yes (IABS) |
| Designated agency recognized | No | Yes | No (intermediary instead) |
| Dual agency permitted | Yes, with consent | Yes, with consent | No (intermediary model) |
| Timing of disclosure | Before confidential info shared | Before signing representation | At first substantive dialogue |
| Penalty for non-disclosure | Up to $10,000 + license action | Up to $5,000 + license action | Up to $1,000 + license action |

For agents comparing state-by-state requirements, the [Utah agency disclosure framework](/blog/utah-agency-disclosure-requirements-2026) offers a useful contrast to Nevada's approach, particularly on the designated agency question.
