---
title: "Maryland Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Maryland agency disclosure requirements 2026 explained for licensed agents—specific forms, deadlines, penalties, and broker audit steps to stay compliant."
...
tags: ["agency-disclosure-requirements", "maryland", "compliance"]
keywords: ["Maryland agency disclosure requirements 2026", "maryland real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Maryland?"
    a: "You must provide the Understanding Whom Real Estate Agents Represent form at the first scheduled meeting where a substantive discussion about real estate needs occurs. This applies to both buyers and sellers before any confidential information is exchanged."
  - q: "What happens if I forget to give the Maryland agency disclosure form?"
    a: "Failure to deliver the disclosure can result in disciplinary action by the Maryland Real Estate Commission, including fines up to $5,000 per violation, license suspension, and potential deal rescission by the aggrieved party."
  - q: "Do I need a new disclosure form for dual agency in Maryland?"
    a: "Yes. Maryland requires separate written consent from both buyer and seller before dual agency begins. The consent must be documented on a form distinct from the initial agency disclosure, and both parties must sign before you proceed."
  - q: "Who is responsible for keeping copies of the signed agency disclosure in Maryland?"
    a: "The broker is responsible for retaining signed copies of all agency disclosure forms for a minimum of five years. Individual agents should also keep copies in their transaction files, but the statutory retention obligation falls on the supervising broker."
---
...
Agents dealing with [multiple active transactions](/blog/track-multiple-active-deals) face amplified risk because a single process failure can cascade across several files before anyone catches it.
...
Understanding [where deals commonly break down](/blog/where-deals-break-down) helps frame why disclosure failures tend to surface at the worst possible moment—during disputes over inspection credits, appraisal gaps, or commission negotiations.
