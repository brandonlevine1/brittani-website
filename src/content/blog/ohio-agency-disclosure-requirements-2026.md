---
title: "Ohio Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Ohio agency disclosure requirements 2026 explained with form numbers, deadlines, and penalties agents face for non-compliance."
...
tags: ["agency-disclosure-requirements", "ohio", "compliance"]
keywords: ["Ohio agency disclosure requirements 2026", "ohio real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Ohio?"
    a: "You must provide the Consumer Guide to Agency Relationships at the earliest practicable time, but no later than the first substantive contact with a prospective buyer or seller. Waiting until a showing or listing appointment has already started is too late."
  - q: "What form number is the Ohio agency disclosure?"
    a: "The Ohio Division of Real Estate and Professional Licensing prescribes the Consumer Guide to Agency Relationships. Most brokerages use Ohio REALTORS Form 200 or their MLS-equivalent version that mirrors the statutory language from ORC 4735.55."
  - q: "What happens if I forget to give the agency disclosure in Ohio?"
    a: "Failure to deliver the disclosure can result in disciplinary action by the Ohio Division of Real Estate, including fines up to $2,500 per violation, license suspension, and potential rescission of the transaction by the aggrieved party."
  - q: "Do I need a new disclosure if I switch from showing homes to writing an offer?"
    a: "No, but you must clarify any change in your agency relationship before the duties shift. If you initially acted as a subagent and now represent the buyer exclusively, a new written consent under ORC 4735.56 is required before proceeding."
---
...
Ohio does not have a single state-issued form number the way some states do. Instead, the Division of Real Estate prescribes the content and format of the Consumer Guide to Agency Relationships, and the [Ohio Division of Real Estate and Professional Licensing](https://com.ohio.gov/divisions-and-programs/real-estate-and-professional-licensing) publishes the required template language. Most practicing agents encounter it through their local association forms library.
...
| Form / Document | Purpose | Timing of Delivery |
|---|---|---|
| Consumer Guide to Agency Relationships (Form 200 equivalent) | Disclose available agency types and agent duties | First substantive contact |
| Exclusive Buyer Agency Agreement | Establish buyer representation | Before or at time of offer |
| Dual Agency Consent (ORC 4735.56) | Written consent from both parties for dual agency | Before dual agency duties begin |
| Limited Service Disclosure | Clarify reduced duties in limited service arrangement | At listing or buyer agreement execution |

Beyond the Consumer Guide, agents must also secure written agency agreements before rendering certain services. Since the NAR settlement reshaped buyer representation practices nationally, Ohio brokerages have tightened their internal policies around when buyer agency agreements must be signed — a topic we covered in depth in our [NAR settlement one-year review](/blog/nar-settlement-year-one).
...
|---|---|---|
| Consumer Guide delivery | Signed/acknowledged copy in every transaction file | Every transaction |
| Dual agency consent | Separate written consent from both parties, dated before dual service began | Every in-house transaction |
| Buyer agency agreement | Executed before substantive buyer services rendered | Every buyer transaction |
| Form version | Matches current Division-prescribed language | Annually at minimum |
| Electronic delivery logs | Timestamp and read-receipt documentation for digital disclosures | Every transaction using e-delivery |
...
Training is part of enforcement. Brokers who can document that they trained agents on disclosure requirements — and disciplined those who violated policy — fare better in administrative proceedings than those who relied on a single onboarding session years ago. Our post on [training new agents on transaction timelines](/blog/training-new-agents-timelines) covers how to build structured compliance checkpoints into your onboarding program.
...
| Requirement | Ohio | Pennsylvania | Illinois |
|---|---|---|---|
| Form type | Consumer Guide (prescribed content) | Disclosure of agency form at first meeting | Consensual dual agency form, no mandated consumer guide |
| Timing trigger | First substantive contact | Before first substantive discussion | At earliest opportunity |
| Dual agency | Permitted with written consent | Permitted with written consent | Permitted with written consent (designated standard) |
| Penalty range | Up to $2,500/violation, suspension, revocation | Fines, suspension, revocation | Fines, suspension, revocation |
| Signature required on disclosure | Not statutorily required but strongly recommended | Yes | Yes for dual agency consent |

For agents comparing requirements across state lines, our coverage of [Pennsylvania agency disclosure](/blog/pennsylvania-agency-disclosure-requirements-2026) and [Illinois agency disclosure](/blog/illinois-agency-disclosure-requirements-2026) breaks down those states' specific obligations.
