---
title: "Illinois Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Illinois agency disclosure requirements 2026 explained for agents and brokers—forms, deadlines, penalties, and the mistakes that kill deals."
...
tags: ["agency-disclosure-requirements", "illinois", "compliance"]
keywords: ["Illinois agency disclosure requirements 2026", "illinois real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Illinois?"
    a: "You must provide the disclosure at the earliest of the first substantive contact with a consumer—before discussing any confidential information, showing property, or beginning negotiations."
  - q: "What form do Illinois agents use for agency disclosure?"
    a: "Illinois agents use the form prescribed under Section 15-35 of the Real Estate License Act (225 ILCS 454/15-35), commonly fulfilled by the Illinois REALTORS form titled 'Consent to Dual Agency' and the 'No Agency / Disclosure' form depending on the relationship."
  - q: "What happens if I forget to give agency disclosure in Illinois?"
    a: "Failure to disclose can result in IDFPR disciplinary action including fines up to $25,000 per violation, license suspension, deal rescission, and civil liability for damages caused by the non-disclosure."
  - q: "Do I need a separate disclosure for dual agency in Illinois?"
    a: "Yes. Illinois requires a separate written consent for dual agency under 225 ILCS 454/15-45, signed by all parties before the licensee acts as a dual agent—general agency disclosure alone is not sufficient."
---
...
If you are also working across state lines, comparing Illinois to other states' frameworks can be instructive. The [Texas agency disclosure requirements](/blog/texas-agency-disclosure-requirements-2026) share some structural similarities but differ significantly in timing and form usage.
...
| Form / Document | Purpose | Timing | Signature Required |
|---|---|---|---|
| Designated Agency Disclosure | Discloses agent's role to consumer | First substantive contact | Consumer acknowledgment |
| Consent to Dual Agency (buyer) | Obtains buyer's written dual agency consent | Before dual representation begins | Buyer signature |
| Consent to Dual Agency (seller) | Obtains seller's written dual agency consent | Before dual representation begins | Seller signature |
| No Agency Disclosure | Clarifies no representation exists | Before providing services to a non-client | Consumer acknowledgment |
...
For agents who struggle to keep track of which forms have been signed across multiple active files, tools that [track multiple active deals](/blog/track-multiple-active-deals) become essential for compliance.
...
|---|---|---|
| Disclosure form completion | Every new transaction file | Signature, date, timing relative to first contact |
| Dual agency consent | Every dual agency transaction | Separate forms for buyer and seller, signed before dual role began |
| Designated agency documentation | Quarterly | Written designation by managing broker on file |
| Open house protocols | Semi-annually | Agents carry disclosure forms, training on trigger conversations |
| File retention | Annually | All disclosure docs retained for minimum 5 years per 225 ILCS 454/5-30 |
...
The [NAR settlement changes over the past year](/blog/nar-settlement-year-one) have made buyer agency agreements more prominent in agents' workflows, but they do not replace or modify Illinois's statutory disclosure requirements. The two obligations run in parallel, and brokers need to verify both are being met.

Brokers who have scaled beyond a handful of transactions per month will recognize the pattern described in [where deals break down](/blog/where-deals-break-down)—compliance gaps grow proportionally with volume unless systems catch them upstream.

## Dual Agency: Illinois's Specific Consent Requirements
