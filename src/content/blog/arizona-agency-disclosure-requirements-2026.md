---
title: "Arizona Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Arizona agency disclosure requirements 2026 explained with specific forms, statutes, common mistakes, and broker audit steps to stay compliant."
...
tags: ["agency-disclosure-requirements", "arizona", "compliance"]
keywords: ["Arizona agency disclosure requirements 2026", "arizona real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Arizona?"
    a: "You must provide the agency disclosure before a buyer or seller discloses confidential information or signs any binding agreement, per A.R.S. 32-2153(A). The standard is at first substantive contact."
  - q: "What form do Arizona agents use for agency disclosure?"
    a: "Most agents use the Arizona Association of Realtors Agency Disclosure and Election form, or the Arizona Department of Real Estate-approved disclosure that satisfies A.R.S. 32-2153. Your brokerage may also have a proprietary version."
  - q: "What happens if I forget to provide agency disclosure in Arizona?"
    a: "Failure to disclose can result in ADRE disciplinary action including fines up to $1,000 per violation, license suspension, and potential civil liability if a party claims they were harmed by the omission."
  - q: "Do I need a new agency disclosure if I switch from showing homes to writing an offer for a buyer?"
    a: "Not necessarily a new form, but you must confirm the buyer's election of agency type before drafting the offer. If the relationship changes from a customer to a client, you need a new signed acknowledgment reflecting that shift."
---
...
Fourth, training must be documented. ADRE investigators reviewing a complaint will look at whether the broker provided training on agency disclosure. Annual compliance meetings, written memos, or LMS records all serve as evidence of supervisory diligence. Brokers who handle this through [structured training protocols for new agents](/blog/training-new-agents-timelines) are far less likely to face shared liability.

## How Arizona Compares to Other States

Arizona's timing requirement—disclosure before confidential information is exchanged—is more aggressive than many states. In [Texas](/blog/texas-agency-disclosure-requirements-2026), for example, the Information About Brokerage Services form must be provided at first substantive dialogue, but the statutory language focuses on "first substantive dialogue" rather than the confidentiality trigger. In [Virginia](/blog/virginia-agency-disclosure-requirements-2026), disclosure is required at the earliest practicable time, which courts have interpreted somewhat flexibly.
