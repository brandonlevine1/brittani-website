---
title: "Massachusetts Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "Massachusetts agency disclosure requirements 2026 explained for agents and brokers—forms, timing, penalties, and common mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "massachusetts", "compliance"]
keywords: ["Massachusetts agency disclosure requirements 2026", "massachusetts real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in Massachusetts?"
    a: "You must provide the Massachusetts Mandatory Licensee-Consumer Relationship Disclosure form at the first personal meeting where substantive real estate matters are discussed. This applies to both buyers and sellers."
  - q: "What form number do Massachusetts agents use for agency disclosure?"
    a: "Massachusetts agents use the Mandatory Licensee-Consumer Relationship Disclosure form prescribed by 254 CMR 3.00 and published by the Board of Registration of Real Estate Brokers and Salespersons. There is no separate numbered form like some states—the Board issues a standardized template that must be used as-is."
  - q: "What happens if I forget to give the disclosure form in Massachusetts?"
    a: "Failure to provide timely disclosure can result in disciplinary action by the Board of Registration, including fines, license suspension, or revocation. It can also expose you to civil liability and give a party grounds to rescind the transaction."
  - q: "Do I need to provide agency disclosure at an open house in Massachusetts?"
    a: "Yes. If substantive real estate discussions occur at an open house, disclosure is required. Many brokers require agents to have printed disclosure forms available at every open house to avoid compliance gaps."
---
...
The governing authority here is [Massachusetts General Laws Chapter 112, Section 87AAA](https://www.mass.gov/info-details/board-of-registration-of-real-estate-brokers-and-salespersons-statutes-and-regulations), paired with the regulations found in 254 CMR 3.00. Together, these statutes mandate that licensees provide a written disclosure of their agency role at the earliest substantive contact with a consumer. The Board publishes a standardized form—the Mandatory Licensee-Consumer Relationship Disclosure—that agents must present without alteration.
...
| Disclosure Element | Massachusetts Requirement |
|---|---|
| Form source | Board of Registration standardized template |
| Timing | First personal meeting with substantive discussion |
| Consumer signature | Required; note refusal if consumer declines |
| Alteration permitted | No substantive changes allowed |
| Dual agency consent | Separate written consent required beyond the disclosure form |
| Retention period | Minimum 3 years per 254 CMR 2.00 |
...
The distinction matters because many agents confuse the disclosure form with the consent form. Handing someone the Mandatory Licensee-Consumer Relationship Disclosure does not authorize you to practice dual agency. That requires a second document, a second signature, and a second conversation. If you are handling [multiple active deals](/blog/track-multiple-active-deals) simultaneously, the risk of confusing which clients have consented to what multiplies fast.
...
| Consequence | Impact |
|---|---|
| Board fine | Up to several thousand dollars per violation |
| License suspension | Typically 30-90 days for first offense |
| License revocation | Reserved for repeat or egregious violations |
| Civil damages | Compensatory and potentially punitive |
| Transaction rescission | Rare but legally available to aggrieved party |
| E&O insurance implications | Carrier may deny coverage if disclosure was willfully omitted |
