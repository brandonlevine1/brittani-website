---
title: "New Jersey Agency Disclosure Requirements 2026: What Every Agent Must Get Right"
description: "New Jersey agency disclosure requirements 2026 explained for agents and brokers—forms, deadlines, penalties, and common mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "new-jersey", "compliance"]
keywords: ["New Jersey agency disclosure requirements 2026", "new jersey real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "When do I have to give the agency disclosure form in New Jersey?"
    a: "You must provide the Consumer Information Statement (CIS) at the first contact with a buyer or seller where substantive real estate discussions occur. This is before any confidential information is shared or property is shown."
  - q: "What form do NJ agents use for agency disclosure?"
    a: "New Jersey agents use the Consumer Information Statement (CIS), which is the form prescribed by N.J.A.C. 11:5-6.2. There is no separate form number—it is the standardized document issued by the New Jersey Real Estate Commission."
  - q: "What happens if I forget to give the disclosure form in New Jersey?"
    a: "Failure to provide the CIS can result in disciplinary action by the NJ Real Estate Commission, including fines up to $10,000 per violation, license suspension, and potential transaction rescission by the aggrieved party."
  - q: "Do I need a signed agency disclosure for dual agency in New Jersey?"
    a: "Yes. Dual agency requires separate written informed consent from both the buyer and seller beyond the initial CIS. Both parties must sign acknowledging the dual agency relationship before you proceed."
---
...
If you have been tracking how other states handle similar obligations, the [Pennsylvania agency disclosure requirements](/blog/pennsylvania-agency-disclosure-requirements-2026) offer a useful comparison because both states share a Mid-Atlantic legal tradition that emphasizes consumer protection at the point of first contact.
...
| Relationship | Who the Agent Represents | Fiduciary Duties Owed | Consent Required |
|---|---|---|---|
| Seller's Agent | Seller exclusively | Full fiduciary to seller | Listing agreement |
| Buyer's Agent | Buyer exclusively | Full fiduciary to buyer | Buyer representation agreement |
| Disclosed Dual Agent | Both buyer and seller | Limited fiduciary to both | Written consent from both parties |
| Transaction Broker | Neither party exclusively | Facilitation duties only | Written disclosure to both parties |
...
Transaction brokerage in New Jersey is less common but gaining traction after the [NAR settlement changes](/blog/nar-settlement-year-one) reshaped compensation discussions. Agents choosing this path owe honesty, disclosure of material facts, and competent service—but not loyalty or confidentiality to either party in the traditional fiduciary sense.
...
The [real cost of missed deadlines](/blog/real-cost-of-missed-deadlines) extends well beyond a fine—it includes lost referrals, E&O premium increases, and the reputational damage that follows any public disciplinary action.
...
|---|---|---|
| CIS on file for every active client | Weekly | Signed/acknowledged CIS in transaction folder |
| Dual agency consent forms | Per transaction | Separate consent beyond CIS, property-specific |
| Open house sign-in logs with CIS | Per event | Full CIS text displayed, initials collected |
| Electronic delivery confirmations | Monthly | Read receipts or e-signature timestamps |
| Team delegation documentation | Quarterly | Clear records of who delivered CIS and when |
...
Training matters as much as auditing. Brokers who hold quarterly compliance reviews—not just annual CE reminders—see dramatically fewer violations. The NJREC's [public enforcement database](https://www.njconsumeraffairs.gov/rec/Pages/default.aspx) shows that repeat offenders almost always come from offices where compliance training stopped at onboarding.

Consider how the [Michigan agency disclosure requirements](/blog/michigan-agency-disclosure-requirements-2026) handle broker oversight differently—Michigan places more explicit statutory language on the broker's duty to supervise—but the practical takeaway is the same: if your agents are not disclosing properly, the Commission will come for the broker's license too.
