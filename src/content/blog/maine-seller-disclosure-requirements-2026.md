---
title: "Maine Seller Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Maine seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, liability risks, and common compliance errors to avoid."
...
tags: ["seller-disclosure-requirements", "maine", "compliance"]
keywords: ["Maine seller disclosure requirements 2026", "maine real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to provide a seller disclosure form in Maine?"
    a: "Yes. Under 33 MRSA §173, residential sellers of one-to-four-unit properties must complete and deliver the Maine Property Disclosure Statement before or at the time of a purchase agreement."
  - q: "What happens if a Maine seller refuses to fill out the disclosure form?"
    a: "The buyer receives written notice that no disclosure will be provided, and the buyer then has the right to rescind the contract within a specific timeframe outlined in the purchase agreement."
  - q: "Is a Maine listing agent liable if the seller lies on the disclosure?"
    a: "An agent is not liable for inaccuracies in the seller's statements unless the agent had actual knowledge of the defect or failed to disclose a material fact independently known to them."
  - q: "Does the Maine disclosure requirement apply to foreclosures or estate sales?"
    a: "Certain exemptions exist under 33 MRSA §174, including court-ordered sales, foreclosures, and transfers between co-owners—but agents should confirm each transaction's eligibility individually."
---
