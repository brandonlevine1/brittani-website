---
title: "California Agency Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "California agency disclosure requirements 2026 explained with form numbers, deadlines, liability risks, and common agent mistakes to avoid."
...
tags: ["agency-disclosure-requirements", "california", "compliance"]
keywords: ["California agency disclosure requirements 2026", "california real estate compliance", "agency disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to give the agency disclosure form before showing a property in California?"
    a: "Yes. Under Civil Code Section 2079.16, the listing agent must provide the Disclosure Regarding Real Estate Agency Relationships form as soon as practicable prior to entering into a listing agreement, and the buyer's agent must provide it before the buyer executes an offer."
  - q: "What happens if I forget to get the AD form signed in California?"
    a: "The buyer may rescind the purchase agreement before or after close of escrow, and you face potential disciplinary action from the DRE, including fines up to $10,000 per violation."
  - q: "Who is responsible for confirming agency in a dual agency situation in California?"
    a: "Both the listing agent and the selling agent must confirm agency on the purchase agreement or in a separate writing, and the broker must ensure the written consent of both buyer and seller is obtained before acting as a dual agent."
  - q: "What form number is used for agency disclosure in California?"
    a: "The California Association of Realtors form AD (Agency Disclosure) is the standard form, paired with the AC (Agent Confirmation) section typically found in the Residential Purchase Agreement (RPA) or provided as a standalone confirmation."
---
...
|------|---------|--------|-----------|
| AD (Agency Disclosure) | Explains agency options | Before listing (seller) or before offer (buyer) | Agent delivers; party acknowledges |
| AC (Agent Confirmation) | Confirms actual agency elected | In the purchase agreement or separate writing | Both agents and both principals |
| Dual Agency Consent | Documents informed consent to dual agency | Before or concurrent with offer | Both buyer and seller |
...
The DRE treats agency disclosure violations as grounds for disciplinary action under Business and Professions Code Section 10176(i). Penalties range from a letter of reprimand to license suspension or revocation. Fines can reach $10,000 per transaction under the Administrative Procedure Act framework the DRE follows. And these actions appear on your [DRE license record](https://www.dre.ca.gov/Licensees/), visible to every client who searches your name.
...
|------------|---------------|----------|
| AD form timing | Date on AD vs. date of listing or offer | Same date or AD dated after listing/offer |
| AC confirmation completeness | All boxes checked, all parties signed | Blank boxes, missing signatures |
| Dual agency consent | Separate written consent from both parties | Consent only from one party or none |
| Electronic delivery consent | Written opt-in for e-delivery on file | No UETA consent but forms sent electronically |
| Mid-transaction changes | Amended AC if agency relationship changed | Original AC contradicts actual conduct |
