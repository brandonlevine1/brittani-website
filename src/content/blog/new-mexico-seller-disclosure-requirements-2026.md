---
title: "New Mexico Seller Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "New Mexico seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, liability risks, and common errors to avoid."
...
tags: ["seller-disclosure-requirements", "new-mexico", "compliance"]
keywords: ["New Mexico seller disclosure requirements 2026", "new mexico real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need to provide a seller disclosure for every residential sale in New Mexico?"
    a: "Yes, under the Property Disclosure Act (NMSA 47-13-1 et seq.), a completed disclosure statement is required for nearly all residential transfers of one to four units, with limited statutory exemptions such as foreclosures and court-ordered sales."
  - q: "What happens if the seller refuses to fill out the disclosure form in New Mexico?"
    a: "If a seller refuses, the buyer gains the right to rescind the purchase agreement. Agents should document the refusal in writing and advise both parties of potential legal exposure."
  - q: "Which form number do New Mexico agents use for seller disclosure?"
    a: "Most agents use RANM Form 2104, the Seller's Property Disclosure Statement, which is maintained and updated by the Realtors Association of New Mexico."
  - q: "Can a New Mexico agent be held liable for incomplete seller disclosures?"
    a: "Yes. Under NMSA 61-29-2 and NMREC Rule 16.61.19 NMAC, agents have an independent duty to disclose material facts they know or should have known, separate from the seller's obligation."
---
...
If you handle transactions across state lines, you will notice New Mexico's approach differs materially from states like [Nevada](/blog/nevada-seller-disclosure-requirements-2026) or [Oklahoma](/blog/oklahoma-seller-disclosure-requirements-2026), which structure their disclosure regimes differently.
...
Failing to comply with New Mexico's seller disclosure requirements generates exposure on multiple fronts. The buyer may rescind the contract outright under Section 47-13-4. Beyond rescission, buyers can pursue damages under the [Unfair Practices Act (NMSA 57-12-1 et seq.)](https://nmonesource.com/nmos/nmsa/en/item/4408/index.do) if they can show a misleading or unconscionable practice connected to the transaction.
...
The cost of a missed disclosure often exceeds the commission earned on the deal. For a deeper look at how timeline failures compound financial risk, see [the real cost of missed deadlines](/blog/real-cost-of-missed-deadlines).
...
Quarterly compliance audits—checking a random sample of closed files for disclosure completeness—are the minimum defensible standard. Brokers who want a structured approach to this can model their process after the steps outlined in [monthly compliance audits](/blog/monthly-compliance-audit).
