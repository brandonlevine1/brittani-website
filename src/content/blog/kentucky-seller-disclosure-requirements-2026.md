---
title: "Kentucky Seller Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Kentucky seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, liability risks, and common mistakes to avoid."
...
tags: ["seller-disclosure-requirements", "kentucky", "compliance"]
keywords: ["Kentucky seller disclosure requirements 2026", "kentucky real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need a seller disclosure form for every residential sale in Kentucky?"
    a: "Yes. KRS 324.360 requires a completed seller's disclosure of condition form for all residential real property transfers of one to four dwelling units, with limited statutory exceptions like foreclosures, court-ordered sales, and transfers between co-owners."
  - q: "What happens if my seller refuses to fill out the disclosure form in Kentucky?"
    a: "If the seller refuses, the buyer has the right to rescind the contract. Agents should document the refusal in writing and advise the seller that non-compliance exposes both the seller and potentially the listing agent to liability."
  - q: "Who is responsible for making sure the Kentucky disclosure form is delivered to the buyer?"
    a: "The listing agent is responsible for ensuring the completed disclosure form is delivered to the buyer or buyer's agent before the buyer makes an offer or, at the latest, before acceptance of the purchase contract."
  - q: "Can a Kentucky seller just write 'as-is' on the disclosure form instead of answering questions?"
    a: "No. Selling 'as-is' does not eliminate the statutory obligation to disclose known material defects. The seller must still complete the disclosure form honestly; 'as-is' only affects the negotiation of repairs, not the duty to inform."
---
...
| Delivery Scenario | Compliance Status | Risk Level |
|---|---|---|
| Before buyer submits offer | Fully compliant | Low |
| At time of offer submission | Technically compliant if before acceptance | Moderate |
| After mutual acceptance | Non-compliant; buyer may rescind | High |
| Never delivered | Statutory violation; license complaint likely | Severe |
...
If you are [tracking multiple active deals](/blog/track-multiple-active-deals), disclosure timing is precisely the kind of deadline that slips when your pipeline expands.
...
For agents who worry about [where deals break down](/blog/where-deals-break-down), disclosure failures are among the most preventable yet most expensive failure points.
...
Managing brokers carry supervisory liability under KRS 324.160 and 201 KAR 11:121. If an agent in the office repeatedly fails to collect or deliver disclosures, the broker faces discipline for inadequate supervision. A [monthly compliance audit](/blog/monthly-compliance-audit) that specifically checks disclosure status on every active listing is not optional—it is a regulatory expectation.

| Audit Checkpoint | What to Verify | Red Flag |
|---|---|---|
| Disclosure form on file | Completed Form 305 in transaction folder | Missing form or blank sections |
| Delivery confirmation | Signed receipt or email timestamp to buyer's agent | No delivery record before contract acceptance |
| Lead paint addendum | Separate EPA form for pre-1978 properties | Missing entirely on qualifying listings |
| Mid-transaction updates | Amended disclosure if new defects discovered | Original form unchanged despite inspection findings |
| Exemption documentation | Written basis for any claimed statutory exception | Agent relying on verbal exemption claim |
...
Brokers dealing with rapid growth should recognize that compliance gaps widen as deal volume increases. If your office is [scaling from five to fifteen deals](/blog/scaling-from-5-to-15-deals) per agent per quarter, disclosure tracking cannot remain a manual spreadsheet exercise.
...
Agents licensed in multiple states or working border-market transactions need to understand that Kentucky's disclosure framework differs from its neighbors. Agents working the Greater Cincinnati market, for example, must not confuse Kentucky requirements with [Ohio seller disclosure requirements](/blog/ohio-seller-disclosure-requirements-2026). Similarly, agents near the Tennessee border should review [Tennessee's distinct statutory framework](/blog/tennessee-seller-disclosure-requirements-2026).

| Requirement | Kentucky | Ohio | Tennessee |
|---|---|---|---|
| Governing statute | KRS 324.360 | ORC 5302.30 | TCA 66-5-201 |
| Standard form | KAR Form 305 | Ohio Residential Property Disclosure Form | TN Residential Property Condition Disclosure |
| Delivery timing | Before offer or acceptance | Before offer or acceptance | Before offer |
| Rescission right for late delivery | Yes | Yes | Yes |
| "As-is" eliminates disclosure duty | No | No | No |
