---
title: "Arkansas Seller Disclosure Requirements 2026: What Every Agent and Broker Must Get Right"
description: "Arkansas seller disclosure requirements 2026 explained for agents and brokers—statutes, forms, common mistakes, and liability risks you can't afford to ignore."
...
tags: ["seller-disclosure-requirements", "arkansas", "compliance"]
keywords: ["Arkansas seller disclosure requirements 2026", "arkansas real estate compliance", "seller disclosure requirements"]
type: "regulatory"
faq:
  - q: "Do I need a seller disclosure for every residential sale in Arkansas?"
    a: "No. Arkansas Code 18-44-104 exempts certain transfers including foreclosures, court-ordered sales, transfers between co-owners, and sales by fiduciaries such as executors or trustees. Standard owner-occupied residential sales do require the disclosure."
  - q: "What happens if my seller refuses to fill out the disclosure form?"
    a: "If the seller refuses and no statutory exemption applies, the buyer may cancel the contract within the allowed timeframe without penalty. Agents should document the refusal in writing and consult their broker immediately."
  - q: "How long does a buyer have to rescind after receiving the Arkansas disclosure?"
    a: "Under Arkansas Code 18-44-107, the buyer has five business days after receipt of the disclosure to rescind the purchase agreement if the disclosure reveals material information not previously known."
  - q: "Who is liable if a known defect is left off the Arkansas disclosure form?"
    a: "The seller bears primary liability for intentional omissions. However, if the listing agent had actual knowledge of the defect and failed to disclose it, the agent and their brokerage may face civil liability, disciplinary action from AREC, and potential license suspension."
---
...
|---|---|---|
| Standard owner-occupied sale | Yes | 18-44-103 |
| Foreclosure sale by lender | No | 18-44-104(1) |
| Transfer by court order (probate, divorce) | No | 18-44-104(3) |
| Sale by executor or trustee | No | 18-44-104(4) |
| Transfer between co-owners | No | 18-44-104(6) |
| New construction (never occupied) | No | 18-44-104(9) |
| Sale by investor/non-occupant owner | Yes | No exemption applies |
...
For agents working in digital transaction environments, electronic delivery is permissible under the [Uniform Electronic Transactions Act](https://www.arkleg.state.ar.us/Acts/FTPDocument?path=%2FACTS%2F2001%2FPublic%2F&file=1439.pdf&ddBiennession=2001%2F2001R) as adopted by Arkansas. However, confirming read-receipt or acknowledgment of delivery remains the agent's responsibility. Relying on an email "sent" status without confirmation is insufficient proof of delivery if the transaction is later challenged.
...
Transaction cancellation is the most immediate risk. Under 18-44-107, a buyer who receives a late or incomplete disclosure can walk away from the deal within the statutory window. For agents whose income depends on closings, a preventable disclosure error that kills a deal represents both a financial loss and a reputational hit that compounds over time. Understanding [where deals commonly break down](/blog/where-deals-break-down) helps agents build systems that prevent these failures.
...
|---|---|---|
| Disclosure form version | Quarterly | Confirm agents use the current year's form |
| Completion review | Every listing | No blank fields; "unknown" marked where applicable |
| Delivery documentation | Every transaction | Timestamped proof of buyer receipt |
| Amendment tracking | Ongoing through listing period | Any post-disclosure defect discoveries documented |
| Exemption documentation | Each exempt transaction | Written basis for exemption filed in transaction record |

**Brokers should require that every listing file contain a completed disclosure or a written explanation of the applicable exemption before marketing begins.** This single policy eliminates the most common audit failure—a missing disclosure discovered only when the buyer's lender or attorney requests it mid-transaction. Implementing a [monthly compliance audit](/blog/monthly-compliance-audit) catches gaps before they become complaints.
