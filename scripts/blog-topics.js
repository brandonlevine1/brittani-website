...
export const TYPE2_TOPICS = [
  ...
  // Expansion — workflow & systems (added 2026-09-25 to refill the exhausted daily-generation pool)
  { slug: 'post-inspection-repair-addendum-workflow', title: 'The Post-Inspection Repair Addendum Workflow That Prevents Renegotiation Chaos' },
  { slug: 'lender-appraisal-order-tracking', title: 'How to Track the Lender Appraisal Order So Nothing Stalls' },
  { slug: 'seller-net-sheet-preparation', title: 'How to Prepare a Seller Net Sheet That Never Gets Questioned' },
  { slug: 'transaction-timeline-template-system', title: 'Building a Reusable Transaction Timeline Template for Every Deal Type' },
  { slug: 'handling-financing-contingency-extensions', title: 'How to Handle Financing Contingency Extensions Without Panic' },
  { slug: 'coordinating-dual-closings', title: 'Coordinating Back-to-Back (Dual) Closings on the Same Day' },
  { slug: 'title-defect-resolution-workflow', title: 'The Title Defect Resolution Workflow That Keeps Closings on Track' },
  { slug: 'managing-seller-concession-credits', title: 'How to Track Seller Concessions and Credits Cleanly Through Closing' },
  { slug: 'pre-listing-document-checklist', title: 'The Pre-Listing Document Checklist That Speeds Up Every Sale' },
  { slug: 'coordinating-va-fha-loan-conditions', title: 'Coordinating VA and FHA Loan Conditions Without Last-Minute Surprises' },
  { slug: 'escrow-holdback-tracking', title: 'How to Manage Escrow Holdbacks for Post-Closing Repairs' },
  { slug: 'power-of-attorney-closing-coordination', title: 'Closing With a Power of Attorney: The TC Coordination Checklist' },
  { slug: 'coordinating-well-septic-inspections', title: 'Coordinating Well, Septic, and Rural Property Inspections' },
  { slug: 'managing-contract-amendment-versions', title: 'How to Keep Contract Amendment Versions Straight Across a Deal' },
  { slug: 'closing-cost-estimate-reconciliation', title: 'Reconciling the Closing Cost Estimate Against the Final CD' },
  { slug: 'coordinating-1031-exchange-timelines', title: 'Coordinating a 1031 Exchange Closing: Deadlines You Cannot Miss' },
  { slug: 'buyer-lender-document-collection', title: 'A Simple System for Collecting Buyer Lender Documents on Time' },
  { slug: 'home-warranty-coordination', title: 'Home Warranty Coordination: The Small Detail That Prevents Big Complaints' },
  { slug: 'tracking-hoa-estoppel-requests', title: 'How to Order and Track HOA Estoppel Certificates Before They Delay Closing' },
  { slug: 'post-closing-file-audit-system', title: 'The Post-Closing File Audit System That Keeps You Compliant' },
];
...
export const TYPE3_TOPICS = [
  ...
  // Expansion — opinion & industry (added 2026-09-25 to refill the exhausted daily-generation pool)
  { slug: 'tc-role-in-2027', title: 'What the Transaction Coordinator Role Looks Like in 2027' },
  { slug: 'end-to-end-digital-closings-reality', title: 'End-to-End Digital Closings: How Close Are We Really?' },
  { slug: 'ai-compliance-monitoring-future', title: 'The Future of AI-Powered Compliance Monitoring in Brokerages' },
  { slug: 'why-transaction-data-is-the-moat', title: 'Why Transaction Data Is Becoming a Brokerage\'s Real Moat' },
  { slug: 'rise-of-fractional-tc-services', title: 'The Rise of Fractional TC Services for Small Teams' },
  { slug: 'closing-delays-macro-economy', title: 'What Closing-Delay Trends Reveal About the Broader Economy' },
  { slug: 'human-in-the-loop-real-estate', title: 'Why "Human in the Loop" Will Define the Next Decade of Real Estate Tech' },
  { slug: 'standardizing-state-disclosures', title: 'Will Disclosure Requirements Ever Be Standardized Across States?' },
  { slug: 'operational-excellence-as-brand', title: 'How Operational Excellence Became a Brokerage Brand' },
  { slug: 'cost-of-compliance-software-sprawl', title: 'The Hidden Cost of Compliance Software Sprawl' },
  { slug: 'what-buyers-agents-owe-post-settlement', title: 'What Buyer\'s Agents Actually Owe Clients After the Settlement' },
  { slug: 'transaction-coordination-as-a-service', title: 'Transaction Coordination as a Service: The Model Reshaping Brokerages' },
  { slug: 'why-speed-to-clear-wins-deals', title: 'Why Speed-to-Clear Is Quietly Winning Deals' },
  { slug: 'data-driven-deadline-management', title: 'The Case for Data-Driven Deadline Management Over Gut Feel' },
  { slug: 'generational-shift-in-agent-tools', title: 'The Generational Shift in the Tools Agents Actually Adopt' },
  { slug: 'insurance-crisis-transaction-timelines', title: 'How the Home-Insurance Crisis Is Reshaping Transaction Timelines' },
  { slug: 'what-title-industry-disruption-means', title: 'What Title-Industry Disruption Means for Everyday Closings' },
  { slug: 'compliance-culture-vs-compliance-tools', title: 'Compliance Is a Culture Problem Before It\'s a Tools Problem' },
  { slug: 'agentic-ai-in-transaction-management', title: 'Agentic AI in Transaction Management: Hype, Reality, and the Line Between' },
  { slug: 'the-invisible-work-of-tcs', title: 'The Invisible Work of Transaction Coordinators (And Why It Finally Matters)' },
];
